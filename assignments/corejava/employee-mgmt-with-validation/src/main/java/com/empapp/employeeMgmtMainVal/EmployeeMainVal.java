package com.empapp.employeeMgmtMainVal;
...
import com.empapp.service.EmployeeServiceVal;
import com.empapp.exception.EmployeeException;
public class EmployeeMainVal extends EmployeeException{
    static int option;
    ...
    public static void main(String[] args) throws EmployeeException {
        ...
        EmployeeServiceVal empSer = new EmployeeServiceVal();
    ...
    static Employee getEmp(Employee emp) {
        EmployeeServiceVal empSer1 = new EmployeeServiceVal();
        Scanner scn = new Scanner(System.in);
