...
public class EmployeeStatsMain extends EmployeeException{
   ...
   public static EmployeeServiceStatsImpl empSer = new EmployeeServiceStatsImpl();
    static void printHeader() {
        System.out.println("EmpID \t" + "Name\t" + "Age\t" + "Designation\t" + "Department\t" + "Country\t" + "Salary");
    }
    ...
    static Employee getEmp(Employee emp) {
        EmployeeServiceStatsImpl empSer1 = new EmployeeServiceStatsImpl();
        Scanner scn = new Scanner(System.in);
