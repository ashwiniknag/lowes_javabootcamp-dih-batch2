package com.empapp.employeeMainSpringCore;
...
import com.empapp.config.EmployeeConfig;
...
public class EmpMainSpringCore {
    static int option;
    ...
    public static EmployeeService empSer;
    ...
    public static void main(String[] args) throws EmployeeException {
        ...
        empSer =context.getBean("employeeService", EmployeeService.class);
    ...
    static Employee getEmp(Employee emp) {
        EmpServiceSpringCoreImpl empSer1 = new EmpServiceSpringCoreImpl();
        Scanner scn = new Scanner(System.in);
